 ...
 */
class getTbCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\TbCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbCategoryRepository.php';

        return $container->privates['App\\Repository\\TbCategoryRepository'] = new \App\Repository\TbCategoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
