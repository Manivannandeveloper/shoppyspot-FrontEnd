...
class __TwigTemplate_70187a5a19d4a208592a545a5495fd7e85b54f12dfc0cafb65c74a897040cc01 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"list-pagination\">
    <div class=\"list-pagination-counter\">
        ...
        if (((array_key_exists("render_detailed_pagination", $context)) ? ((isset($context["render_detailed_pagination"]) || array_key_exists("render_detailed_pagination", $context) ? $context["render_detailed_pagination"] : (function () { throw new RuntimeError('Variable "render_detailed_pagination" does not exist.', 7, $this->source); })())) : (true))) {
            // line 8
            echo "            ";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("paginator.results", ["%count%" => sprintf(twig_get_attribute($this->env, $this->source, (isset($context["paginator"]) || array_key_exists("paginator", $context) ? $context["paginator"] : (function () { throw new RuntimeError('Variable "paginator" does not exist.', 8, $this->source); })()), "numResults", [], "any", false, false, false, 8))], "EasyAdminBundle");
            echo "
        ";
        }
        // line 10
...
", "@EasyAdmin/crud/paginator.html.twig", "D:\\MyLearning\\Freelancing\\shoppyspot\\back-end-service\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\paginator.html.twig");
    }
}
