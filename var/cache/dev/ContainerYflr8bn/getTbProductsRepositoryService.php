 ...
 */
class getTbProductsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbProductsRepository' shared autowired service.
     *
     * @return \App\Repository\TbProductsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbProductsRepository.php';

        return $container->privates['App\\Repository\\TbProductsRepository'] = new \App\Repository\TbProductsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
