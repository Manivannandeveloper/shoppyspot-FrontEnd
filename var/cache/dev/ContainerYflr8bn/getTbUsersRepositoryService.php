 ...
 */
class getTbUsersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbUsersRepository' shared autowired service.
     *
     * @return \App\Repository\TbUsersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbUsersRepository.php';

        return $container->privates['App\\Repository\\TbUsersRepository'] = new \App\Repository\TbUsersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
